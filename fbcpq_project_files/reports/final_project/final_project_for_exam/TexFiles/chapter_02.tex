...
\begin{table}[h]
    ...
    \begin{tabular}{ c | c | c | c | c | c | c | c | c }
        \textbf{Group} & \textbf{Cheese} & \textbf{Total Solids} & \textbf{Ash} & \textbf{pH} & \textbf{NaCl} & \textbf{Salt-In-Moisture} & \textbf{D-Lactate} & \textbf{L-Lactate} \\
        \hline
...
\begin{table}[h]
    ...
    \rowcolors{2}{white}{gray!7}
    \begin{tabular}{ c | c | c | c | c | c | c | c | c }
        \textbf{Group} & \textbf{Cheese} & \textbf{Total N} & \textbf{Protein} & \textbf{pH 4.6--SN} & \textbf{Formol N} & \textbf{Ammonium N} & \textbf{Fat} & \textbf{Fat acidity} \\
        \hline
...
The results showed significantly lower total nitrogen and protein content in the analysed feta cheese compared to the other cheeses, as presented in table \ref{tab:comparison_02}. This reflects the limited proteolysis occurring during the short ripening time and high salt conditions of feta production. The pH 4.6-soluble nitrogen fraction was significatnly lower in feta compared to Grana Padano, however, it was higher than in Brie, indicating some degree of protein degradation. Formol-titratable nitrogen and ammonium nitrogen were also low in feta, consistent with limited amino acid release and deamination.
