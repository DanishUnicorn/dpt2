...
\begin{itemize}
    \item $m_2$ = weight of nitrogen in the filtrate determined by DUMAS [mg]
    \item $m_1$ = weight of cheese sample used for extraction [g]
    \item $N\%$ = nitrogen content in the filtrate determined by DUMAS [\%]
\end{itemize}
