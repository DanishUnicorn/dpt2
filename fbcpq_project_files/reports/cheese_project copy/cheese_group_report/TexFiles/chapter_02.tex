...
The volatile profile of Feta cheese is characterized by a distinct set of aroma compounds that differentiate it from other cheese varieties. The most abundant volatiles include free fatty acids, alcohols, and esters, respectively. In this section, these groups are described with emphasis on the most abundant individual compounds with respective tables for visualisation. Data has been derived from the study by \citeauthor{a01_kondyli2012effect} \cite{a01_kondyli2012effect}.

\subsection{Free Fatty Acids}
Free fatty acids (FFAs) were the most abundant compounds in the volatile fraction of Feta cheese. At 180 days of ripening, the five dominant FFAs were decanoic (C10:0), acetic (C2:0), palmitic (C16:0), myristic (C14:0) and dodecanoic (C12:0) acids, as shown in Table \ref{tab:tab_ffa_180days}. These medium- and long-chain fatty acids contribute to the characteristic flavour profile of Feta, with C10:0 in particular associated with strong rancid notes due to its low sensory threshold.

\vspace{0.5em}
Packaging affected the quantitative distribution of these FFAs. Cheeses stored in tin vessels contained significantly (P < 0.05) lower levels of C10:0 and slightly lower levels of C16:0 and C14:0 compared with those ripened in wooden barrels, while C12:0 showed only a minor decrease. Despite these differences, C10:0 and C2:0 remained the two most abundant FFAs across both packaging conditions at 180 days \textcite{a01_kondyli2012effect}.
...
\subsection{Alcohols}
Alcohols represented the second most abundant group of volatile compounds in Feta cheese at 180 days of ripening. The five dominant alcohols were ethanol, butan-2-ol, 3-methylbutan-1-ol, phenylethanol and butan-1-ol, as shown in Table \ref{tab:tab_alcohols_180days}. Ethanol was present at the highest concentration, reflecting ongoing fermentative activity during brining and storage. Butan-2-ol and 3-methylbutan-1-ol were also present at high levels and originate primarily from microbial metabolism of residual carbohydrates and amino acids.

\vspace{0.5em}
Packaging had a marked influence on the quantitative profile of these alcohols. Cheeses ripened in wooden barrels contained substantially higher levels of ethanol, butan-2-ol, phenylethanol and butan-1-ol compared with cheeses stored in tin vessels, indicating more active fermentative and amino acid catabolic pathways in the wooden environment. In contrast, 3-methylbutan-1-ol showed similar concentrations in both packaging types. Despite these quantitative differences, the identity of the dominant alcohols remained consistent across storage conditions \textcite{a01_kondyli2012effect}.
...
\subsection{Esters}
Esters formed the third most abundant group of volatile compounds in Feta cheese at 180 days of ripening. The five dominant esters were ethyl hexanoate, ethyl octanoate, ethyl butanoate, ethyl decanoate and 2-phenylethyl acetate, as shown in Table \ref{tab:tab_esters_180days}. These compounds are primarily formed through esterification between free fatty acids and ethanol or other alcohols, and they contribute fruity, floral and sweet notes that balance the sharper acidic components of the cheese.

\vspace{0.5 em}
A clear effect of packaging was observed. Cheeses ripened in wooden barrels contained markedly higher concentrations of all five esters compared with cheeses stored in tin vessels, indicating that the wooden environment favoured ester synthesis. The differences were especially pronounced for ethyl hexanoate, ethyl octanoate and ethyl butanoate, which were present at more than an order of magnitude higher levels in wooden barrels. Despite these quantitative differences, the identity of the major esters remained consistent across both packaging types \textcite{a01_kondyli2012effect}.
