...
\begin{enumerate} 
    \item \textbf{Cutting the Milk Gel:} Cutting the coagulum into smaller grains accelerates syneresis by significantly increasing the surface area available for whey escape and reducing the distance (l) the whey must travel to reach the grain surface. Finer cuts lead to higher flow velocities (v) and lower moisture content in the final cheese. 
