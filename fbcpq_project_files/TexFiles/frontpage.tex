\begin{titlepage}
    ...
    \begin{textblock}{9.4}(0,7.5)
        \Huge{\fontfamily{ptm}\selectfont\bfseries{Dairy Product Technology 2}}
    \end{textblock}
      \begin{textblock}{9.4}(0,8.5)
        \Huge{\fontfamily{ptm}\selectfont\bfseries{NFOK16006U }}
    \end{textblock}
    
    \begin{textblock}{9.4}(0,9.5)
        \LARGE{\fontfamily{ptm}\selectfont\bfseries{Notes taken during the course, including lectures, exercises, curriculum, practicals, and group reports}}
    \end{textblock}
